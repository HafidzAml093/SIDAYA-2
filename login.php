...
<head>
    ...
    <meta name="description" content="Sistem Informasi Manajemen">
    <meta name="author" content="">

    <title>SIDAYA-UNIVERSITAS-ISLAM-MULIA</title>
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" action="cek_login.php" method="post">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="exampleInputusername" aria-describedby="usernameHelp" placeholder="Enter username..." name="username" required>
                                        </div>
                                        <div class="form-group">
